...
openssl req -new -key ./ca_certificates/server.key \
        ...
        -x509 \
        -subj '/C=AT/ST=Tyrol/L=Innsbruck/O=GeoVille Information Systems and Data Processing GmbH/CN=api.clcplusbackbone.geoville.com/emailAddress=IT-Services@geoville.com'
