...
t2_apply_model_fast_lane_data_filter_model = api.model('t2_apply_model_fast_lane_data_filter_model',
                                                       {
...
t2_apply_model_fast_lane_request_model = api.model('t2_apply_model_fast_lane_request_model',
                                                   {
