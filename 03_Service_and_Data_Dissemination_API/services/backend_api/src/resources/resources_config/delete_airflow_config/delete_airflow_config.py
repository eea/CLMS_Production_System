...
class DeleteAirflowConfiguration(Resource):
    ...
    def delete(self):
        ...
        try:
            ...
            gemslog(LogLevel.ERROR, f"'message': {error.to_dict()}", 'API-delete_airflow_config')
            ...
            gemslog(LogLevel.INFO, 'Deleted entire airflow config table', 'API-delete_airflow_config')
            return '', 204
