...
from models.models_services.task_2_apply_model.task_2_apply_model_model import t2_apply_model_request_model
...
class Task2ApplyModel(Resource):
    ...
    This class defines the API call for starting the apply model (Task 2) workflow. The class consists of one methods
    which accepts a POST request. For the POST request a JSON with several parameters is required, defined in the
    corresponding model.
