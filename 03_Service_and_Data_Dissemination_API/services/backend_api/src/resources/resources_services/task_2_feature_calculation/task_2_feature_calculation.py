...
from models.models_services.task_2_feature_calculation.task_2_feature_calculation_model import t2_feature_calculation_request_model
    ...
    def post(self):
        ...
        try:
            ...
            if not payload_check[0]:
                ...
                gemslog(LogLevel.WARNING, f"'message': {error.to_dict()}", 'API-feature_calculation_t2', order_id)
            ...
            gemslog(LogLevel.INFO, f'Request payload: {req_args}', 'API-feature_calculation_t2', order_id)
            ...
            gemslog(LogLevel.ERROR, f"'message': {error.to_dict()}", 'API-feature_calculation_t2', order_id)
            ...
            gemslog(LogLevel.INFO, f'Request successful', 'API-feature_calculation_t2', order_id)
            return {
