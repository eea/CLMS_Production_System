...
from models.models_services.task_1_batch_classification.task_1_batch_classification_model import t1_batch_classification_request_model
...
class Task1BatchClassification(Resource):
    ...
    This class defines the API call for starting the batch classification (Task 1) workflow. The class consists of one
    ...
    def post(self):
        ...
        try:
            ...
            if not payload_check[0]:
                ...
                gemslog(LogLevel.WARNING, f"'message': {error.to_dict()}", 'API-batch_classification', order_id)
            ...
            gemslog(LogLevel.INFO, f'Request payload: {req_args}', 'API-batch_classification', order_id)
            ...
            gemslog(LogLevel.ERROR, f"'message': {error.to_dict()}", 'API-batch_classification', order_id)
            ...
            gemslog(LogLevel.INFO, f'Request successful', 'API-batch_classification', order_id)
            return {
