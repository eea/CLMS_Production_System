...
def call_postprocessing_1(**kwargs):
    ...
    res = requests.get('http://postprocessing-testing-t1.task-1-testing:80/postprocessing', params = {"process_id": pid})
...
dag = DAG(
    ...
    description='testing stitching dag',
