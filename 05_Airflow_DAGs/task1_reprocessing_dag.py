...
def call_postprocessing_1(**kwargs): 
    ...
    res = requests.get("http://post-processing.task-1-production:5000/cell_for_reprocessing", params={"code": pu, 
    "process_id": pid})
...
dag = DAG(
    ...
    description='task1 reprocessing',
...
dag.doc_md = """
#### DAG Summary
Pipeline to reprocess grids in task 1
"""
