...
default_args = {
    ...
    'queue': 'test_k8s_podoperator_dag',
    # 'pool': 'backfill',
    # 'priority_weight': 10,
...
def call_grid_service(**kwargs): 
    ...
    res = requests.get("http://grid-service-testing-t1.task-1-testing:80/eea_grid", params={"cell_code_input": pu, 
    "process_id": pid})
...
def call_calc_feature_s2(feat_dict, pu, pid, features, **kwargs):
    ...
    use_cache = get_data_from_payload("use_cache", str, False, **kwargs)
...
#            raise(f"rule set was not able to be loaded as json: {e}")
    ...
    params = {"process_id": pid, "data_source": "wekeo_S2", "resolution": "10", "cloudmask_type": "Fmask4",
              ...
              "aoi_coverage": aoi_coverage, "to_upload": True, "use_cache": bool(use_cache), "resampling": "bi_cubic"}
...
def call_gaf_seg(**kwargs): 
 ...
 #       raise(f"rule set was not able to be loaded as json: {e}")
    ...
    params = {"epsg": 3035, "path_prefix": path_prefix, "process_id": pid, "use_aoi": False, "cellcode": pu}
